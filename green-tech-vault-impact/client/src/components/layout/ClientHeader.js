...
const ClientHeader = () => {
  ...
  const renderMenu = (
    ...
    >
      ...
      <MenuItem onClick={() => { navigate('/dashboard/company-profile'); handleMenuClose(); }}>
        <ListItemIcon>
      ...
      <MenuItem onClick={() => { navigate('/dashboard/notifications'); handleMenuClose(); }}>
        <ListItemIcon>
      ...
      <MenuItem onClick={() => { navigate('/dashboard/qr-login'); handleMenuClose(); }}>
        <ListItemIcon>
      ...
      <MenuItem onClick={() => { navigate('/dashboard/announcements'); handleMenuClose(); }}>
        <ListItemIcon>
