  ...
  const tutorials = [
    {
      ...
      icon: <GuideIcon sx={{ fontSize: 40, color: '#4ECDC4' }} />,
      link: '#'
    },
    {
      title: 'Video Tutorials',
      description: 'Watch step-by-step videos of common tasks',
      icon: <VideoIcon sx={{ fontSize: 40, color: '#4ECDC4' }} />,
      link: '#'
    },
    {
      title: 'User Forums',
      description: 'Join discussions with other users',
      icon: <ForumIcon sx={{ fontSize: 40, color: '#4ECDC4' }} />,
      link: '#'
    }
  ];
