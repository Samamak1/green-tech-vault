...
const ContactPage = () => {
  ...
  return (
    <Box>
      ...
      {/* Footer */}
      <Box sx={{ bgcolor: '#064e40', color: 'white', py: 4 }}>
        <Container maxWidth="lg">
          <Grid container spacing={4}>
            <Grid item xs={12} sm={4}>
              <Box sx={{ mb: 2 }}>
                ...
                <Box 
                  component="svg" 
                  viewBox="0 0 100 100" 
                  sx={{ width: 50, height: 50, fill: 'white' }}
                >
                  <rect x="10" y="15" width="80" height="70" fill="none" stroke="white" strokeWidth="4" />
                  <circle cx="30" cy="35" r="8" fill="white" />
                  <polygon points="20,65 40,45 60,65" fill="white" />
                  <polygon points="45,65 65,45 85,65" fill="white" />
                </Box>
              </Box>
            ...
            <Grid item xs={6} sm={2}>
              ...
              <Stack spacing={1}>
                ...
                <Link href="#" color="inherit" underline="hover">Certifications</Link>
                <Link href="#" color="inherit" underline="hover">Locations</Link>
            ...
            <Grid item xs={6} sm={2}>
              ...
              <Stack spacing={1}>
                <Link href="#" color="inherit" underline="hover">Let's Get Educated</Link>
                <Link href="#" color="inherit" underline="hover">Reports</Link>
